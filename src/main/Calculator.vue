...
export default {
    data: function() {
        return {
            ...
            operation: null,
            values: [0, 0], 
            current: 0 //indica qual dos dois valores acima está sendo trabalhado, de índice 0 ou 1
        }
    },
    components: {
        Button,
    ...
    methods: {
        ...
        addDigit(n) {
            //verifica se o dígito digitado é um ponto, e também se já existe o ponto no valor dentro do display
...
.calculator {
    ...
    grid-template-rows: 1fr 90px 90px 90px 90px 90px;
}
</style>
